...
- git log --grep="текст комментария" --all --oneline - поиск коммита во всех ветках по части текста комментария. Пример, если нужно найти коммит у которого текст комментария "commit 5", то выполнить комманду git log --grep="commit 5" --all --oneline
